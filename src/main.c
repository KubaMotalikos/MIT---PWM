...
void init(void)
{
    ...
    TIM2_OC1Init(TIM2_OCMODE_PWM1, TIM2_OUTPUTSTATE_ENABLE, 5000, TIM2_OCPOLARITY_HIGH);
    //konfigurace output channel 1 - mod PWM1 - povolím - šířka impulzu - nastavení poalrity 
